...
def configure_parser():
    ...
    parser.add_argument('--vsi_fraction', '-v', default=1.0, type=float, 
        help='Fraction of vsi files to extract stats from. Must be a number between 0 and 1. Defaults to 1')
...
def update_histogram(histogram, update_hist, gamma):
    return (histogram + gamma*update_hist)/(1 + gamma)
